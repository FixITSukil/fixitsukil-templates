...
export const restaurant: SiteConfig = {
  ...
  primary: "#b91c1c",
  accent: "#f59e0b",
  heroImg: "/templates/restaurant.jpg",
  heroEmoji: "🍽️",
...
export const property: SiteConfig = {
  ...
  primary: "#0369a1",
  accent: "#f97316",
  heroImg: "/templates/property.jpg",
  heroEmoji: "🏡",
...
export const portfolio: SiteConfig = {
  ...
  primary: "#6d28d9",
  accent: "#ec4899",
  heroImg: "/templates/portfolio.jpg",
  heroEmoji: "✨",
